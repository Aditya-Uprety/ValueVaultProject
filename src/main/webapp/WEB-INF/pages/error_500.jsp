...
<head>
    ...
    <title>Server Error - ValueVault</title>
    ...
    <div class="login-container">
        <div class="login-card" style="text-align:center;padding:52px 40px;">
            ...
            <h1 style="font-family:'Cinzel',serif;font-size:22px;margin-bottom:10px;
                       color:var(--text-white);">Something Went Wrong</h1>

            <p style="color:var(--text-muted);font-size:14px;line-height:1.7;
                      margin-bottom:28px;">
                An unexpected error occurred on our end. This has been noted.<br>
                Please try again, or return to the platform.
            </p>
